...
exports.COLLECTIONS = ['default', 'harmful', 'pii'];
...
exports.AGENTIC_STRATEGIES = ['crescendo', 'goat', 'jailbreak', 'jailbreak:tree'];
...
exports.ALL_STRATEGIES = ['default', ...exports.DEFAULT_STRATEGIES, ...exports.ADDITIONAL_STRATEGIES];
