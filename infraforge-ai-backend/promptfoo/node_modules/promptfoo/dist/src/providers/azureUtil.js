...
function maybeEmitAzureOpenAiWarning(testSuite, tests) {
    const hasAzure = testSuite.providers.some((p) => p instanceof azure_1.AzureChatCompletionProvider || p instanceof azure_1.AzureCompletionProvider);
...
//# sourceMappingURL=azureUtil.js.map