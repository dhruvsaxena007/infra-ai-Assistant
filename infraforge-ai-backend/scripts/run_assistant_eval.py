    ...
    for i, case in enumerate(cases):
        try:
            ...
            r = {
                ...
                "category": (case.get("id") or "").split("_")[0],
                "pass": False,
                "failures": [f"exception: {exc}"],
                "query": case.get("message") or "",
                "reply": "",
                "mode": "",
                "category_detected": "",
                "city": "",
                ...
                "suggestions": [],
                "reply_language": "",
                "scores": {k: 0 for k in ("intent_match", "response_relevance", "language_match", "result_quality", "helpfulness")},
                "overall_quality": 0,
                "issues": [str(exc)],
                "optimize": True,
                "optimization_hints": ["Fix runtime exception"],
