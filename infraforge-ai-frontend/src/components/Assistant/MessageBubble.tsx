...
import ChatComparisonBlock from "./ChatComparisonBlock";
...
function MessageBubble({
  ...
  const showExtras = !message.isGenerating && !message.isError;
    ...
    >
      ...
      >
        ...
        >
          ...
          <div
            className="max-h-[min(60vh,420px)] overflow-y-auto scrollbar-hide"
            aria-live={message.isGenerating ? "off" : "polite"}
            aria-busy={message.isGenerating || undefined}
          >
            {isUser || message.isError ? (
              ...
              <AssistantMessageContent
                ...
                usePlainText={Boolean(message.isGenerating) || message.generationComplete !== true}
                indicatorFading={indicatorFading}
              />
            )}
          </div>
        </div>

        {showExtras && message.comparison && (
          <ChatComparisonBlock data={message.comparison} />
        )}

        {showExtras && message.advisorMessage && (
        ...
        {showExtras && message.suggestions && message.suggestions.length > 0 && (
        ...
        {showExtras && message.handover?.enabled && message.handover.actions && (
