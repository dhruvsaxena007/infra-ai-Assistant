...
exports.redteam = exports.providers = exports.cache = exports.assertions = exports.generateTable = void 0;
    ...
    const constructedTestSuite = {
        ...
        prompts: (await Promise.all(testSuite.prompts.map(async (promptInput) => {
            if (typeof promptInput === 'function') {
                ...
                return (0, prompts_1.readPrompts)(promptInput);
            }
            try {
                return prompts_2.PromptSchema.parse(promptInput);
            }
            catch (error) {
