import type { ApiProvider, GradingConfig, GradingResult, ProviderType } from './types';
...
export declare function renderLlmRubricPrompt(rubric: string, llmOutput: string, grading?: GradingConfig, vars?: Record<string, string | object>): string;
