 ...
 */
export declare function synthesize({ entities: entitiesOverride, injectVar, language, maxConcurrency, plugins, prompts, provider, purpose: purposeOverride, strategies, delay, abortSignal, }: SynthesizeOptions): Promise<{
    purpose: string;
    entities: string[];
